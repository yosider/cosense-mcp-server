// copied from https://jsr.io/@kitsonk/xhr/0.5.1/globals.d.ts
// In @kitsonk/xhr, it is said that you can use it by specifying `jsr:@kitsonk/xhr/globals` in `types`, but it was not recognized in Deno 2.4.0, so I hard coded it directly in the repository.
// The module description was removed because it causes an error in the doc test.
